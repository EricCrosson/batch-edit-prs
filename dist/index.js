...
var EventManager = class {
  ...
  on(dispatch, handler2) {
    this.emitter.addListener(dispatch, handler2);
  }
  once(dispatch, handler2) {
    this.emitter.once(dispatch, handler2);
  }
  off(dispatch, handler2) {
    this.emitter.off(dispatch, handler2);
  }
  complete() {
